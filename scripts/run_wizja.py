"""
Skrypt startowy: Warstwa Wizji
Uruchamia CVAgent - detekcja obiektów, śledzenie i integracja z Lidarem.
"""
import os
import sys
import subprocess
...
COMPONENT_DIR = os.path.join(PROJECT_ROOT, "src", "warstwa_wizji")
...
def main():
    ...
    print(f"[INFO] Uruchamianie: Warstwa Wizji (CVAgent)")
