"""
Skrypt startowy: Warstwa Audio - Reporter
Uruchamia moduł reportera odpowiedzialny za komunikację z LLM i kamerą.
"""
import os
import sys
import subprocess
...
COMPONENT_DIR = os.path.join(PROJECT_ROOT, "src", "warstwa_audio")
