"""
Skrypt startowy: Consolidator
Uruchamia konsolidator danych łączący informacje z Lidara i Kamery.
"""
import os
import sys
import subprocess
...
COMPONENT_DIR = os.path.join(PROJECT_ROOT, "consolidator")
